...
export interface Lesson {
    ...
    title: string;
    content: string;
    labId?: 'box-model' | 'layout-spatial' | 'flex-box' | 'grid-layout' | 'specificity' | 'event-loop' | 'closure-scope' | 'prototype-chain' | 'this-binding' | 'bundler-flow' | 'webpack-pipeline' | 'typescript-check' | 'typescript-advanced' | 'lint-format-lab' | 'ci-cd-lab' | 'virtual-dom' | 'react-hooks' | 'react-perf-lab' | 'state-mgmt' | 'component-patterns' | 'fiber-architecture' | 'web-vitals-lab' | 'resource-hints-lab' | 'media-optimization-lab' | 'code-splitting-lab' | 'crp-process' | 'web-workers' | 'http-cache' | 'xss-lab' | 'cors-lab' | 'jwt-lab' | 'csrf-lab' | 'csp-lab' | 'node-event-loop' | 'http-request-lab' | 'resource-model-lab' | 'status-code-lab' | 'validation-schema-lab' | 'auth-boundary-lab' | 'session-cookie-lab' | 'data-schema-lab' | 'constraint-guard-lab' | 'async-boundary-lab' | 'stream-lab' | 'middleware-lab' | 'big-o-lab' | 'sorting-lab' | 'tree-lab' | 'recursion-lab' | 'array-ll-lab' | 'stack-queue-lab' | 'hash-table-lab' | 'search-lab' | 'dp-lab' | 'design-patterns-lab' | 'mfe-lab' | 'solid-lab' | 'concurrency-lab' | 'deep-clone-lab' | 'reactivity-lab' | 'monitoring-lab' | 'metric-trend-lab' | 'trace-lab' | 'alert-noise-lab' | 'virtual-list-lab' | 'queue-retry-lab' | 'idempotency-lab' | 'upload-pipeline-lab' | 'object-storage-lab' | 'system-design-lab' | 'data-flow-lab' | 'degradation-lab' | 'transaction-lab' | 'index-query-lab' | 'rbac-lab' | 'cache-aside-lab' | 'cache-consistency-lab' | 'cache-incident-lab' | 'signed-url-lab' | 'rate-limit-lab' | 'api-contract-lab' | 'dns-lab' | 'tls-handshake-lab' | 'cdn-cache-lab' | 'reverse-proxy-lab' | 'realtime-protocol-lab' | 'network-debug-lab' | 'network-security-lab' | 'threat-model-lab' | 'attack-surface-lab' | 'input-security-lab' | 'form-validation-lab' | 'auth-route-lab' | 'payment-state-lab';
}
