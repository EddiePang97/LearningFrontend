...
const LAB_COMPONENTS: Record<LabId, React.LazyExoticComponent<React.ComponentType>> = {
    ...
    'async-boundary-lab': lazyNamed(() => import('./labs/AsyncBoundaryLab'), 'AsyncBoundaryLab'),
    ...
    'trace-lab': lazyNamed(() => import('./labs/TraceLab'), 'TraceLab'),
    ...
    'degradation-lab': lazyNamed(() => import('./labs/DegradationLab'), 'DegradationLab'),
    ...
    'cache-incident-lab': lazyNamed(() => import('./labs/CacheIncidentLab'), 'CacheIncidentLab'),
